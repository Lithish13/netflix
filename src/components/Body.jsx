...
const Body = () => {
  ...
  return (
    <>
      <div className="body">
        <h1 className="text-white text-3xl font-bold mt-2 ml-20 ">
          Trending now{" "}
        </h1>
        <div className="h-[200px]">
          <ul className="flex gap-6 sm:gap-12 md:gap-16 lg:gap-20 px-4 sm:px-10 mt-4 overflow-x-auto no-scrollbar  ">
            <li className="card1 h-[200px]  flex-shrink-0 ">
              <img
                className="h-[170px] hover:h-full  flex-shrink-0"
                src="https://occ-0-4994-2164.1.nflxso.net/dnm/api/v6/mAcAr9TxZIVbINe88xb3Teg5_OA/AAAABRhpHnfh6ia4QcotnBIjOTFL15LZcxTPjXf5VFU_E_ayrXSswVPM_vAfqrmSoUqf-gC_bRjsC6918GtEasl95dPq6PmppVAHtndE5xrFBIzsX0JVN6c9w-0AVT1lkdh3b6Xa.webp?r=2b8&quot"
              />
              <span
                aria-hidden="true"
                data-content="1"
                className="default-ltr-cache-1j6jwcf espbvdl1 text-6xl font-black   -left-5 bottom-25 relative  text-white "
              >
                1
              </span>
            </li>
            <li className="card2 h-[200px] flex-shrink-0 ">
              <img
                className="h-[170px] hover:h-full "
                src="https://occ-0-4994-2164.1.nflxso.net/dnm/api/v6/mAcAr9TxZIVbINe88xb3Teg5_OA/AAAABcK02fNAXg4aOs5yvSF21rM5tNJUY_CpdHczoWzv6Jx9piGyD2nSXtuAhJZtzUWTXOynw38JtkN78cU5dHzG2K-cAJVvWhJcve-ChY3uorTAXlC5hgeaXvgLZLX4AAc6na5h.webp?r=c28&quot"
              />
              <span
                aria-hidden="true"
                data-content="1"
                className="default-ltr-cache-1j6jwcf espbvdl1 text-6xl font-black -left-6 bottom-25 relative text-white "
              >
                2
              </span>
            </li>{" "}
            <li className="card3 h-[200px]  flex-shrink-0">
              <img
                className="h-[170px] hover:h-full "
                src="https://occ-0-4994-2164.1.nflxso.net/dnm/api/v6/mAcAr9TxZIVbINe88xb3Teg5_OA/AAAABU73BvQjJgydQFEJ-vZZw9QtO8fL6lIxc71x9tOqxgDWh_BHokCWPIbGC5AxJjDk0D_sIH5KhmmYm9HLr3DKUXg8eo6nzF0rtSI.webp?r=d95&quot"
              />
              <span
                aria-hidden="true"
                data-content="1"
            ...
            <li className="card4 h-[200px]  flex-shrink-0">
              <img
                className="h-[170px] hover:h-full "
                src="https://occ-0-4994-2164.1.nflxso.net/dnm/api/v6/mAcAr9TxZIVbINe88xb3Teg5_OA/AAAABaW57jWqw0Gs9gqgmW816THwyNfPqphIiruQRFy9KXtt9PTPJpB4kzDKriPcpNjPKCj0itu1Yfjl-CR8rGEokBHPKE4O9lZQHXHRRpUHEelwoKk8lOf4gqlws-HnR2iZeSk4.webp?r=609&quot"
              />
              <span
                aria-hidden="true"
                data-content="1"
            ...
            <li className="card5 h-[200px]   flex-shrink-0">
              <img
                className="h-[170px] hover:h-full "
                src="https://occ-0-4994-2164.1.nflxso.net/dnm/api/v6/mAcAr9TxZIVbINe88xb3Teg5_OA/AAAABace3lfDYdvDP5GhS8n6Djz3jW0sjZtFLOYIGR9fQQS48CE1DC8PQ8-DlTy5qKPDPjeQcfX7AVJzFKz2zW2lsbUq5yiYN0g1NmTRk6F4dajOtAdVKLn_bBW6tGbQr22e74Mx.webp?r=fb9&quot"
              />
              <span
                aria-hidden="true"
                data-content="1"
            ...
            <li className="card6 h-[200px]   flex-shrink-0">
              <img
                className="h-[170px] hover:h-full "
                src="https://occ-0-4994-2164.1.nflxso.net/dnm/api/v6/mAcAr9TxZIVbINe88xb3Teg5_OA/AAAABfQbkxRwQV_zSeEDI92Hhu86ttq6vTI-NPSom5LdKyBMDQnH1igsOb6RDax9ISrNh5kO1_moHkhPGwegaKDB6vjbSWkpcddy-AGeaMkLfCDuBReX6VSfydIvc-9dldHeD-dw.webp?r=453&quot"
              />
              <span
                aria-hidden="true"
                data-content="1"
            ...
            <li className="card7 h-[200px]  flex-shrink-0 ">
              <img
                className="h-[170px] hover:h-full "
                src="https://occ-0-4994-2164.1.nflxso.net/dnm/api/v6/mAcAr9TxZIVbINe88xb3Teg5_OA/AAAABYUCgDPIk4LvnEw_j-dC5ca65oxm4yP2Z7RFKlRcN6WYzCwNA4MhTNqTRrSAK9zND3cSjrYEpbQculmTCXPD09ZbvdCosdbuOjc.webp?r=062&quot"
              />
              <span
                aria-hidden="true"
                data-content="1"
            ...
            <li className="card8 h-[200px]  flex-shrink-0 ">
              <img
                className="h-[170px] hover:h-full "
                src="https://occ-0-4994-2164.1.nflxso.net/dnm/api/v6/mAcAr9TxZIVbINe88xb3Teg5_OA/AAAABQmIFk_PeW2I2K3n3xcYkRA_gWBZgvkWWdxPSrRcHKqUUivmZMwEsmlO6LEeiEjGUOOdqwpEa3s6ICacFfqZ8SnqF0q4lU4cl1c.webp?r=748&quot"
              />
              <span
                aria-hidden="true"
                data-content="1"
            ...
            <li className="card9 h-[200px]  flex-shrink-0 ">
              <img
                className="h-[170px] hover:h-full "
                src="https://occ-0-4994-2164.1.nflxso.net/dnm/api/v6/mAcAr9TxZIVbINe88xb3Teg5_OA/AAAABVVzJ7Q5ewWWr7Ju9Vpu5gUq1Guy_hTrvChxJceb-sKqWPiIs1YGHsy_iC2mNT5bKs2BepshCHriwd7IQhYM2HPuqd7MBfqMXFL8nXJshtQEi6-KAKZAcSvG7xE3daK4ABuC.webp?r=81a&quot"
              />
              <span
                aria-hidden="true"
                data-content="1"
            ...
            <li className="card10 h-[200px]  flex-shrink-0 ">
              <img
                className="h-[170px] hover:h-full "
                src="https://occ-0-4994-2164.1.nflxso.net/dnm/api/v6/mAcAr9TxZIVbINe88xb3Teg5_OA/AAAABYGL4_ns5MGTE5-Yd3ZQVB5apyY9yxQ39lxjT_27ehdoGzrxRwNc4osgXEeifcv9yO_MgMySL-p6hMxtQZnIEkZmyglIJ7wm7ik.webp?r=c23&quot"
              />
              <span
                aria-hidden="true"
                data-content="1"
                className="default-ltr-cache-1j6jwcf espbvdl1 text-6xl font-black -left-8 bottom-25 relative text-white "
              >
                10
              </span>
            </li>
        ...
        <h1 className="text-white text-2xl font-bold mt-8 ml-20">
          More reasons to join
        </h1>
        <div className="box ml-20 mr-20 mt-6">
          <div className="boxRow1 flex flex-col md:flex-row gap-6">
            <div className="box1 rounded-2xl bg-slate-950 w-full md:w-[48%]">
              <p className="text-white pt-6 pl-6 text-2xl font-bold">
                Enjoy on your TV
              </p>
              <p className="text-slate-300 pt-6 pl-6 text-[15px] ">
                Watch on Smart TVs, Playstation, Xbox, Chromecast, Apple TV,
              </p>
              <p className="text-slate-300 pl-6 text-[15px] ">
                Blu-ray players, and more.
              </p>
              <svg
                width="72"
                height="72"
                className="mt-6  relative left-110 "
                viewBox="0 0 72 72"
                fill="none"
              >
                ...
                <defs>
                  ...
                  >
                    ...
                    <stop offset="0.333333" stopolor="#99161D"></stop>
            ...
            <div className="box2 rounded-[20px] bg-slate-950 w-[550px]">
              <p className="text-white pt-6 pl-6 text-2xl font-bold">
          ...
          <div className="boxRow2 flex gap-8 justify-between mt-6">
            <div className="box3 rounded-[20px] bg-slate-950 w-[550px]">
              <p className="text-white pt-6 pl-6 text-2xl font-bold">
                Watch everywhere
              </p>
              <p className="text-slate-300 pt-6 pl-6 text-[15px] ">
              ...
              <p className="text-slate-300 pl-6 text-[15px] ">laptop and TV.</p>
              <svg
                width="72"
                height="72"
                className="mt-6 relative left-110 "
            ...
            <div className="box4 rounded-[20px] bg-slate-950 w-[550px]">
              <p className="text-white pt-6 pl-6 text-2xl font-bold">
        ...
        <h1 className="text-white text-3xl font-black ml-20 mt-14  ">
          Frequently Asked Questions
        </h1>
        <div>
          <ul className="text-white ml-20 mt-8 mr-20 space-y-3">
            <li className=" bg-gray-700 items-center pl-2">
              <div className="flex justify-between">
                <h2 className="text-2xl font-bold">What is Netflix?</h2>
                {!show && (
                  <i
                    className="fa-solid fa-plus text-2xl mt-1 mr-2 cursor-pointer "
                    onClick={toggleHandler}
                  ></i>
                )}
                {show && (
                  <i
                    className="fa-solid fa-xmark text-xl mt-1 cursor-pointer mr-2"
                    onClick={toggleHandler}
                  ></i>
                )}
              </div>
            ...
            <li className=" bg-gray-700  pl-2 ">
              ...
              {show2 && (
                <p className="mt-2 text-gray-300">
                  ...
                  download your favourite shows with the iOS or Android app. Use
        ...
        <h1 className="text-white text-center mt-15">
          Ready to watch? Enter your email to create or restart your membership.
        </h1>
        <form className="text-center flex justify-center mt-4 ">
          <input
            type="text"
            className="mr-5 text-gray-400 rounded-md border-1 pl-2 w-80 border-gray-400 "
            placeholder="Email Address"
          ></input>
          <div className="flex justify-center bg-red-600 hover:bg-red-700 rounded-md w-36">
        ...
        <p className="ml-20 mt-10 text-gray-500">
          Questions? Call <u>000-800-919-1743</u>
        </p>
        <ul className="ml-20 mt-10 text-gray-500 flex gap-24 ">
          <ul className=" underline space-y-3">
            <li className="hover:text-amber-50">FAQ</li>
            <li className="hover:text-amber-50">Media Center</li>
            <li className="hover:text-amber-50">Ways to Watch</li>
            <li className="hover:text-amber-50">Cookies Preferences</li>
            <li className="hover:text-amber-50">Speed Test</li>
          </ul>
          <ul className=" underline space-y-3">
            <li className="hover:text-amber-50">Help Centre</li>
            <li className="hover:text-amber-50">Jobs</li>
            <li className="hover:text-amber-50">Terms of Use</li>
            <li className="hover:text-amber-50">Contact Us</li>
            <li className="hover:text-amber-50">Corporate Information</li>
          </ul>
          <ul className=" underline space-y-3">
            <li className="hover:text-amber-50">Only on Netflix</li>
            <li className="hover:text-amber-50">Investor Relations</li>
            <li className="hover:text-amber-50">Privacy</li>
            <li className="hover:text-amber-50">Account</li>
            <li className="hover:text-amber-50">Legal Notices</li>
          </ul>
        </ul>
        <div className="text-amber-50 ml-20  mt-8 ">
          <select className="text-center h-8 w-30 ">
            <option className=" text-white bg-black">English</option>
            <option className=" text-white bg-black">Hindi</option>
          </select>
        </div>
        <p className="text-gray-400 ml-20 mt-8 ">Netflix India</p>
        <p className="text-gray-400 ml-20 mt-8 pb-30">
          This page is protected by Google reCAPTCHA to ensure you're not a bot.{" "}
          <u className="text-blue-600">Learn more.</u>
        </p>
      </div>
    </>
  );
